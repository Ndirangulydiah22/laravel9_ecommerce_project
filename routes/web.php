...
// Admin Products All Routes
    ...
    Route::get('/manage/manage-product', [ProductController::class, 'ManageProduct'])->name('manage-product');
...
Route::get('/language/kiswahili', [LanguageController::class, 'Kiswahili'])->name('kiswahili.language');
...
// Add to cart sttore Data with Ajax
...
Route::prefix('blog')->group(function(){
    ...
    Route::get('/blogcategory/delete/{id}', [BlogController::class, 'BlogCategoryDelete'])->name('blog.category.delete');
