                      ...
                      <div class="row product-micro-row">
                        ...
                        <div class="col col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">@if(session()->get('language') == 'Kiswahili') {{ $product->product_name_Kis }} @else {{ $product->product_name_en }} @endif</a></h3>
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            @foreach($categories as $category)
              <li><a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab"> @if(session()->get('language') == 'kiswahili') {{$category -> category_name_kis}} @else {{$category -> category_name_en}} @endif </a></li>
            @endforeach
<!-- 
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          @if(session()->get('language') == 'kiswahili') {{$product -> product_name_kis}} @else {{$category -> category_name_en}} @endif  
                          </a></h3>
                          <div class="rating rateit-small"></div>
  ...
  <div class="action">
    <ul class="list-unstyled">
      <li class="add-cart-button btn-group">
        ...
        <button class="btn btn-primary icon" type="button" title="Add Cart" data-toggle="modal" data-target="#exampleModal"  > <i class="fa fa-shopping-cart" id="{{ $product->id }}" onclick="productView(this.id)"></i> </button>
      ...
      <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart" href="detail.html" title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                  ...
                  @endforeach     
<!--    ////end all option product foreach////// -->
        ...
        @endphp                  
          ...
          <div>
            ...
            @endif
                  ...
                  <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
@if(session()->get('language') == 'hindi') {{ $product->product_name_kis }} @else {{ $product->product_name_en }} @endif
            </a></h3>
          <div class="rating rateit-small"></div>
          <div class="description"></div>
 ...
 <section class="section featured-product wow fadeInUp">
          <h3 class="section-title"> @if(session()->get('language') == 'kiswahili') {{ $skip_category_0->category_name_kis }} @else {{ $skip_category_0->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
        ...
        @endphp                  
          ...
          <div>
            ...
            @endif
                  ...
                  <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
      @if(session()->get('language') == 'kiswahili') {{ $product->product_name_kis }} @else {{ $product->product_name_en }} @endif
            </a></h3>
          <div class="rating rateit-small"></div>
          <div class="description"></div>
...
@if(session()->get('language') == 'kiswahili') {{ $skip_category_1->category_name_kis }} @else {{ $skip_category_1->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if(session()->get('language') == 'kiswahili') {{ $skip_brand_1->brand_name_kis }} @else {{ $skip_brand_1->brand_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            ...
            @foreach($blogpost as $blog)
              <div class="item">
                <div class="blog-post">
                  ...
                  <h3 class="name"><a href="#">@if(session()->get('language') == 'kiswahili') {{ $blog->post_title_kis }} @else {{ $blog->post_title_en }} @endif</a></h3>


                    <span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>

                    <p class="text">@if(session()->get('language') == 'kiswahili') {!! Str::limit($blog->post_details_kis, 100 )  !!} @else {!! Str::limit($blog->post_details_en, 100 )  !!} @endif</p>
                ...
                <div class="product">
                  ...
                  <div class="cart clearfix animate-effect">
                    <div class="action">
                      <ul class="list-unstyled">
                        <li class="add-cart-button btn-group">
                          <button class="btn btn-primary icon" data-toggle="dropdown" type="button"> <i class="fa fa-shopping-cart"  id="{{ $product->id }}" onclick="productView(this.id)"></i> </button>
                          <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                        </li>
