...
@section('title')
Easy Online Shop - {{$product -> product_name_en}}
@endsection
...
@endphp
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name" id="pname"> @if(session()->get('language') == 'kiswahili') {{$product -> product_name_kis}} @else {{$product -> product_name_en}} @endif
								</h1>
   ...
   @endif
				...
				<div class="col-sm-8">
						<div class="reviews">
							...
							@if(session()->get('language') == 'kiswahili') {{$product -> short_descp_kis}} @else {{$product -> short_descp_en}} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(session()->get('language') == 'kiswahili') {!!$product -> long_descp_kis!!} @else {!!$product -> long_descp_kis!!} @endif</div>	
								</div><!-- /.tab-pane -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		...
		<h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
				@if(session()->get('language') == 'kiswahili') {{ $product->product_name_kis }} @else {{ $product->product_name_en }} @endif</a></h3>
