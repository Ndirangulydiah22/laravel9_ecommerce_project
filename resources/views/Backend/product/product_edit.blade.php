...
<div class="col-md-4"> 
    ...
    <div class="controls">
        <input type="text" name="product_name_en" class="form-control" value="{{$products->product_name_en}}" required=""> </div>
        @error('subsubcategory_id') 
        <span class="text-danger">{{$message}}</span>
        @enderror   
...
<div class="form-group">
    <h5>Product Name kis<span class="text-danger">*</span></h5>
    <div class="controls">
        <input type="text" name="product_name_kis" class="form-control" required="" value="{{$products->product_name_kis}}" > </div>
        @error('product_name_kis') 
        <span class="text-danger">{{$message}}</span>
        @enderror   
...
<div class="form-group">
    ...
    <div class="controls">
        <input type="text" name="product_tags_en" class="form-control" data-role="tagsinput" value="{{$products->product_tags_en}}" required=""> </div>
...
<div class="form-group">
    <h5>Product Tags Kis<span class="text-danger">*</span></h5>
    <div class="controls">
        <input type="text" name="product_tags_kis" class="form-control" data-role="tagsinput" value="{{$products->product_tags_kis}}"  > </div>
        @error('product_tags_kis') 
        <span class="text-danger">{{$message}}</span>
        @enderror   
...
<div class="form-group">
    ...
    <div class="controls">
        <input type="text" name="product_size_en" class="form-control" data-role="tagsinput" value="{{$products->product_size_en}}" > </div>
...
<div class="form-group">
    <h5>Product Size Kis<span class="text-danger">*</span></h5>
    <div class="controls">
        <input type="text" name="product_size_kis" class="form-control" data-role="tagsinput" value="{{$products->product_size_kis}}" required="" > </div>
        @error('product_size_kis') 
        <span class="text-danger">{{$message}}</span>
        @enderror   
...
<div class="form-group">
    ...
    <div class="controls">
        <input type="text" name="product_color_en" class="form-control" data-role="tagsinput" value="{{$products->product_color_en}}" required=""> </div>
...
<div class="form-group">
    <h5>Product Colour Kis<span class="text-danger">*</span></h5>
    <div class="controls">
        <input type="text" name="product_color_kis" class="form-control" data-role="tagsinput" value="{{$products->product_color_kis}}" required=""> </div>
        @error('product_color_kis') 
        <span class="text-danger">{{$message}}</span>
        @enderror   
...
<div class="form-group">
    <h5>Short Description Kiswahili<span class="text-danger">*</span></h5>
    <div class="controls">
    <textarea name="short_descp_kis" id="textarea" class="form-control" required placeholder="Textarea text" >
    {!! $products->short_descp_kis !!}
    </textarea> </div>        
    </div>
...
<div class="form-group">
    <h5>Long Description Kiswahili<span class="text-danger">*</span></h5>
    <div class="controls">
    <textarea id="editor2" name="long_descp_kis" rows="10" cols="80" required="">
    {!! $products->long_descp_en !!}
    </textarea> </div>        
    </div>
</div><!-- /.end col-md-6 -->
