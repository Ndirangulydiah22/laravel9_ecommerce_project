...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
		...
		<div class="form-group">
		    ...
		    <input id="email"  type="text" name="email" class="form-control unicase-form-control text-input"  >
        ...
        @enderror
	  	...
	  	<div class="form-group">
		    ...
		    <input type="password" name="password" id="email" class="form-control unicase-form-control text-input"  >
